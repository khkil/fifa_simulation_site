...
export const getPlusOverallFromGrade = (grade) => {
  switch (grade) {
    case 2:
      return 1;
    case 3:
...
export const upgradeValue = () => {
  ...
  // 강화 게이지
  const gauges = [
    [0.81, 0.81, 1.07, 1.42, 1.88, 2.5, 3.31, 4.39, 5, 5, 5, 5], //1~2강
    [0, 0.54, 0.71, 0.94, 1.25, 1.66, 2.2, 2.93, 3.89, 5, 5, 5], //2~3강
    [0, 0, 0.53, 0.71, 0.94, 1.25, 1.65, 2.2, 2.92, 3.88, 5, 5], //3~4강
    [0, 0, 0, 0.57, 0.75, 1, 1.33, 1.67, 2.34, 3.12, 4.15, 5], //4~5강
    [0, 0, 0, 0.57, 0.75, 0.99, 1.33, 1.77, 2.35, 3.13, 4.16, 5], //5~6강
    [0, 0, 0, 0.57, 0.75, 0.99, 1.33, 1.77, 2.36, 3.14, 4.18, 5], //6~7강
    [0, 0, 0, 0.57, 0.75, 0.99, 1.33, 1.77, 2.36, 3.16, 4.21, 5], //7~8강
  ];
};
